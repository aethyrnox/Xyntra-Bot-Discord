...
(async () => {
  try {
    console.log('LOGIN XYNTRA | Please wait. . .'); // Pesan log saat memulai proses deploy
    ...
    console.log('Commands terdaftar di guild.'); // Pesan log saat berhasil mendaftarkan commands
  } catch (err) {
